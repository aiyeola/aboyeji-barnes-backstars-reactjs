...
import SingleAccommodation from '@components/Accommodation/Accommodation';
import Meta from '@components/shared/Meta';

const DashboardPage = ({ destination, trips, computePeriod, updateInput }) => {
  let single;

  if (destination.count > 0) {
    const accommodation = destination.destinations[0];
    const totalRating =
      accommodation.Ratings.length > 0
        ? accommodation.Ratings.map((rate) => rate.rating).reduce(
            (prev, cur) => prev + cur,
          )
        : 0;
    ...
    <>
      ...
      <div className="container">
        ...
        <div className="welcome p-top-5">
          <p className="m-bottom-3">Barnes Backstars</p>
          <div className="grid grid-sm">
            <div className="col-3" />
            <a
              href="/requests"
              className="card home-card col-3 col-sm-6 p-top-2"
            >
        ...
        <div className="grid grid-sm">
          <div className="col-6 col-sm-12">
            <div className="dash-dest">
              <span className="card-title m-left-1">
                MOST BOOKED ACCOMMODATION
              </span>
              <div className="card-body">{single}</div>
            </div>
          </div>
          <div className="col-1" />
          <div className="col-5 col-sm-12">
            <div className="dash-dest">
              <span className="card-title m-left-1">
                Find out your past trips statistics
              </span>
          ...
          <div className="col-12 col-sm-11 offset-1">
            ...
            <div className="requests scroll_container">
              {trips.trips.length > 0 ? (
                ...
                <span className="text-center text-danger card-title">
                  NO TRIPS
                </span>
              )}
            </div>
...
DashboardPage.propTypes = {
  ...
  computePeriod: PropTypes.func.isRequired,
